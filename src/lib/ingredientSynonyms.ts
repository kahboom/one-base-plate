...
export const SYNONYM_GROUPS: readonly (readonly string[])[] = [
  ...
  ['olives', 'black olives', 'green olives', 'kalamata olives', 'kalamata'],
  ['slices of bacon', 'bacon rashers', 'bacon rasher', 'bacon strips'],
  ['streaky bacon', 'back bacon', 'bacon rashers', 'bacon rasher', 'bacon strips', 'bacon'],
  ...
  ['aptamil', 'infant formula', 'baby formula', 'first infant milk'],
  ['fish fingers', 'fish sticks', 'fish stick'],
  ['mangetout', 'snow peas', 'snow pea'],
  ['bok choy', 'pak choi', 'pak choy', 'bokchoy', 'pakchoi'],
  ['sugar snap peas', 'sugar snap pea', 'snap peas', 'snap pea'],
  ['swede', 'rutabaga'],
