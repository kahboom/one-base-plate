...
export function buildHouseholdPath(householdId: string | undefined, itemPath: string): string {
...
export function isSecondaryNavItemActive(
  ...
  if (itemPath === '/meals') {
    return currentPath.startsWith(`${prefix}/meals`) || currentPath.startsWith(`${prefix}/meal/`);
  }
