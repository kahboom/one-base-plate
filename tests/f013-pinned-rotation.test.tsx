...
const ingredients: Ingredient[] = [
  ...
  { id: "peas", name: "peas", category: "veg", tags: [], shelfLifeHint: "", freezerFriendly: true, babySafeWithAdaptation: true },
  { id: "beans", name: "beans", category: "protein", tags: [], shelfLifeHint: "", freezerFriendly: false, babySafeWithAdaptation: true },
  { id: "bread", name: "bread", category: "carb", tags: [], shelfLifeHint: "", freezerFriendly: false, babySafeWithAdaptation: true },
];
...
const meals: BaseMeal[] = [
  ...
  {
    id: "meal-b", name: "Salmon Rice", components: [
    ...
    defaultPrep: "pan-fry", estimatedTimeMinutes: 25, difficulty: "medium",
    rescueEligible: false, wasteReuseHints: [],
  },
  {
    id: "meal-c", name: "Beans on Toast", components: [
      { ingredientId: "beans", role: "protein", quantity: "200g" },
      { ingredientId: "bread", role: "carb", quantity: "2 slices" },
    ],
    defaultPrep: "heat", estimatedTimeMinutes: 10, difficulty: "easy",
    rescueEligible: true, wasteReuseHints: [],
  },
];
...
describe("F013: Pinned meal prioritization in weekly plan engine", () => {
  ...
  it("empty pinnedMealIds produces same results as no pinning", () => {
    ...
    expect(withEmpty.map((d) => d.baseMealId)).toEqual(
      withDefault.map((d) => d.baseMealId),
    );
  });
});
