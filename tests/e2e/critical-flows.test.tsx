...
describe("E2E: Base meal planning flow", () => {
  ...
  it("Alex variant includes preparation rule modifications", () => {
    ...
    const hasChickenRule = alexVariant.instructions.some((i) => i.includes("chicken breast") && i.includes("sliced thin"));
  ...
  it("Riley toddler variant includes safe food detection", () => {
    ...
    const hasSafeFoodInst = rileyVariant.instructions.some((i) => i.includes("Includes safe food") && i.includes("pasta"));
  ...
  it("Sam baby variant includes texture adaptation guidance", () => {
    ...
    const hasTextureInst = samVariant.instructions.some((i) =>
      i.includes("soft") || i.includes("mash") || i.includes("finger-safe") || i.includes("shred") || i.includes("blend"),
    );
