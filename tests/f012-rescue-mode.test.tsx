...
function seedHousehold(
  meals: BaseMeal[] = [rescueMealFast, rescueMealMedium, nonRescueMeal],
): Household {
...
describe('F012: generateRescueMeals engine', () => {
  ...
  it('falls back to all meals when no rescue-eligible meals exist', () => {
    const results = generateRescueMeals([nonRescueMeal], members, ingredients, 'low-time');
  ...
  it('generates assembly variants for each result', () => {
    const results = generateRescueMeals([rescueMealFast], members, ingredients, 'low-time');
