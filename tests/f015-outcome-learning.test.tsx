...
const ingredients: Ingredient[] = [
  { id: "i1", name: "Chicken", category: "protein", tags: [], shelfLifeHint: "", freezerFriendly: false, babySafeWithAdaptation: true },
  { id: "i2", name: "Pasta", category: "carb", tags: [], shelfLifeHint: "", freezerFriendly: false, babySafeWithAdaptation: true },
  { id: "i3", name: "Broccoli", category: "veg", tags: [], shelfLifeHint: "", freezerFriendly: false, babySafeWithAdaptation: true },
  { id: "i4", name: "Salmon", category: "protein", tags: [], shelfLifeHint: "", freezerFriendly: true, babySafeWithAdaptation: true },
  { id: "i5", name: "Rice", category: "carb", tags: [], shelfLifeHint: "", freezerFriendly: false, babySafeWithAdaptation: true },
  { id: "i6", name: "Peas", category: "veg", tags: [], shelfLifeHint: "", freezerFriendly: true, babySafeWithAdaptation: true },
];
...
function makeOutcome(mealId: string, outcome: "success" | "partial" | "failure", index = 0): MealOutcome {
  return {
...
describe("F015: Ranking remains explainable", () => {
  it("outcome labels are human-readable", () => {
    const labels = [
      computeOutcomeScore("x", [makeOutcome("x", "success", 0), makeOutcome("x", "success", 1), makeOutcome("x", "success", 2)]).label,
      computeOutcomeScore("x", [makeOutcome("x", "failure", 0)]).label,
      computeOutcomeScore("x", [makeOutcome("x", "success", 0)]).label,
      computeOutcomeScore("x", [makeOutcome("x", "success", 0), makeOutcome("x", "failure", 1)]).label,
      computeOutcomeScore("x", [makeOutcome("x", "failure", 0), makeOutcome("x", "failure", 1), makeOutcome("x", "success", 2)]).label,
    ];
