...
const ingredients: Ingredient[] = [
  ...
  { id: "ing-steak", name: "steak", category: "protein", tags: [], shelfLifeHint: "", freezerFriendly: true, babySafeWithAdaptation: false },
];
...
const members: HouseholdMember[] = [
  { id: "m-a", name: "Alex", role: "adult", safeFoods: ["pasta"], hardNoFoods: [], preparationRules: [], textureLevel: "regular", allergens: [], notes: "" },
];
