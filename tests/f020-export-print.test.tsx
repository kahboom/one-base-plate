...
const members: HouseholdMember[] = [
  ...
  { id: "m-b", name: "Riley", role: "toddler", safeFoods: ["pasta"], hardNoFoods: [], preparationRules: [], textureLevel: "soft", allergens: [], notes: "" },
];
...
describe("F020 — export content matches saved plan", () => {
  it("exported text matches the saved plan structure", () => {
    ...
    // Both days present
    const dayLines = lines.filter((l) => l.match(/^(Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday)$/));
