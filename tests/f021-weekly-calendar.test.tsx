...
function seedHousehold(opts?: { meals?: BaseMeal[]; weeklyPlans?: WeeklyPlan[] }): Household {
...
describe('F021: Weekly Planner always shows day cards', () => {
  ...
  it('opens meal details modal when suggested recipe link is clicked', async () => {
    ...
    expect(within(modal).getByRole('heading', { level: 2, name: mealName! })).toBeInTheDocument();
  });
