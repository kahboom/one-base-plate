...
console.log("To refresh seed-data.json, run: npm run seed > tmp.json && mv tmp.json src/seed-data.json (or merge manually).");
...
console.log("(Households are stored in IndexedDB Dexie DB 'onebaseplate_app', meta key 'households' — not localStorage.)");
